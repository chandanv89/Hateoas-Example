...
public class CustomerOrderController {
    ...
    public EntityModel<CustomerOrder> getCustomer(@PathVariable("customerId") String customerId) {
        ...
        customer.getOrders()
                .forEach(o -> o.add(linkTo(methodOn(CustomerOrderController.class).getOrder(o.getOrderId()))
                        .withSelfRel()));
    ...
    public CollectionModel<Order> getAllCustomerOrders(@PathVariable("customerId") String customerId) {
        ...
        orders.forEach(o -> o.add(linkTo(methodOn(CustomerOrderController.class).getOrder(o.getOrderId())).withSelfRel()));
    ...
    public CollectionModel<Order> getOrders() {
        ...
        orderList.forEach(o -> {
            o.add(linkTo(methodOn(CustomerOrderController.class).getOrder(o.getOrderId())).withSelfRel());
            o.add(linkTo(methodOn(CustomerOrderController.class).getCustomer(o.getCustomerId())).withRel("customerInfo"));
        });
    ...
    public EntityModel<Order> getOrder(@PathVariable("orderId") String orderId) {
        ...
        return EntityModel.of(order,
                linkTo(methodOn(CustomerOrderController.class).getOrder(orderId)).withSelfRel(),
                linkTo(methodOn(CustomerOrderController.class).getCustomer(order.getCustomerId())).withRel("customerInfo"),
